...
Cohesion: 0.09
Nodes (22): `aptabase`, Aptabase Railway Template — Design, Background, `bump-digest.sh`, `clickhouse`, Correction: there is no `templateCreate`, Data flow, Decisions recorded (+14 more)
